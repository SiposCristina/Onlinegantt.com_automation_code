...
<h3>How to Run It</h3> <p>For performance testing, I ran this command: npx playwright test ganttJson.spec.js --project chromium --headed. I used --project chromium option to run the script in Chromium browser, and --headed mode to see the actual browser window during the test execution.<br>
